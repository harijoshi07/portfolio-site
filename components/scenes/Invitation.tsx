...
const CONTACT_LINKS = [
  {
    label: 'LinkedIn',
    sub: 'in/harijoshi07',
    href: 'https://linkedin.com/in/harijoshi07',
    icon: (
  ...
  },
  {
    label: 'GitHub',
    sub: 'harijoshi07',
    href: 'https://github.com/harijoshi07',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
  ...
  },
  {
    label: 'Twitter',
    sub: '@sometimesIcode_',
    href: 'https://x.com/sometimesIcode_',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
      ...
      <div ref={profileRef} className="flex flex-col items-center gap-4 mb-12 opacity-0">
        ...
        <div className="text-center">
          ...
          <p className="font-mono text-xs tracking-widest uppercase text-gray mt-1">
            Mobile Engineer · KMP Developer · Kathmandu, Nepal
          </p>
        </div>
      </div>
