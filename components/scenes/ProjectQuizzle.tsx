...
const SCREENS = [
  '/screenshots/quizzle/home_screen.png',
  '/screenshots/quizzle/quiz_select_screen.png',
  '/screenshots/quizzle/quiz_mode_screen.png',
  '/screenshots/quizzle/quiz_answer_screen.png',
  '/screenshots/quizzle/quiz_result_screen.png',
]

const PLAY_STORE_REVIEWS = [
  { text: "Fun way to test my knowledge! The offline mode is clutch.", author: "Aarav S.", date: "8 Jan 2025" },
  { text: "Love the clean Material 3 interface. Very smooth.", author: "Pooja Maharjan", date: "22 Jan 2025" },
  { text: "Quiz categories are well organized. Great app!", author: "Rohan Basnet", date: "5 Feb 2025" },
  { text: "Works perfectly offline. My go-to trivia app.", author: "Sabina Limbu", date: "18 Feb 2025" },
  { text: "Incredibly fast and smooth quiz transitions. Highly recommend!", author: "Suman Lama", date: "28 Feb 2025" },
]

const APP_STORE_REVIEWS = [
  { text: "Tracks my progress nicely. Can see improvement over time.", author: "Nabin Dahal", date: "12 Jan 2025" },
  { text: "Simple yet powerful. The Room DB caching is seamless.", author: "Shreya Pandey", date: "1 Feb 2025" },
  { text: "Best open source quiz app I have found!", author: "Dinesh Bhatt", date: "15 Feb 2025" },
  { text: "Clean code, great UX. Learned a lot from the source.", author: "Pawan Rijal", date: "3 Mar 2025" },
  { text: "Great challenge! The dashboard stats are very clean.", author: "Karuna Giri", date: "15 Mar 2025" },
]

export default function ProjectQuizzle() {
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center gap-10 my-6 md:my-0 z-10 w-full max-w-4xl px-6">
        ...
        >
          ...
          <div className="flex flex-row md:flex-col gap-3">
            {/* GitHub Button */}
            <a
              href={project.github || 'https://github.com/harijoshi07/Quizzle'}
              target="_blank"
